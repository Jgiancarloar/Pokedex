...
const ModalPokemon = ({ showModal, onCloseModal, pokemon }) => {
    return (
        ...
        ${showModal ? "visible opacity-100" : "invisible opacity-0"} ${colorByType[pokemon?.types[0]]}`}>
            ...
            <article className={`bg-white h-[85%] absolute w-full
            rounded-t-3xl text-center transition-all duration-500 
